...
def prototype_twitter_HRED():
    ...
    state['train_dialogues'] = "./training_data/Training.dialogues.pkl"
    state['test_dialogues'] = "./training_data/Test.dialogues.pkl"
    state['valid_dialogues'] = "./training_data/Validation.dialogues.pkl"
    state['dictionary'] = "./training_data/Training.dict.pkl"
    state['save_dir'] = "Output"
...
def prototype_ubuntu_HRED():
    ...
    state['train_dialogues'] = "./Training.dialogues.pkl"
    state['test_dialogues'] = "./Test.dialogues.pkl"
    state['valid_dialogues'] = "./Training.dialogues.pkl"
    state['dictionary'] = "./Training.dict.pkl"
    state['save_dir'] = "Output"
